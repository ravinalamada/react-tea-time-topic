  ...
  return (
    <section className="nextTopicis">
      <div className="wrapper">
        <p>{props.title}</p>
        <button id={props.id} onClick={props.archeive}>
          <svg id={props.id} className="w-6 h-6" fill="none" stroke="#D8779A" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path></svg>
        </button>
      </div>
      <div className="wrapper">
